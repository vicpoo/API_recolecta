...
// ================== CREATE ==================
//
func (pg *PostgresRegistroVaciado) Save(r *entities.RegistroVaciado) (*entities.RegistroVaciado, error) {
	sql := `
...
// ================== GET BY ID ==================
//
func (pg *PostgresRegistroVaciado) GetByID(id int32) (*entities.RegistroVaciado, error) {
	sql := `
...
// ================== LIST ALL ==================
//
func (pg *PostgresRegistroVaciado) ListAll() ([]entities.RegistroVaciado, error) {
	sql := `
	SELECT vaciado_id, relleno_id, ruta_camion_id, hora
	FROM registro_vaciado
...
// ================== DELETE ==================
//
func (pg *PostgresRegistroVaciado) Delete(id int32) error {
	_, err := pg.conn.Exec(
		context.Background(),
...
// ================== GET BY RELLENO ==================
//
func (pg *PostgresRegistroVaciado) GetByRellenoID(rellenoID int32) ([]entities.RegistroVaciado, error) {
	sql := `
	SELECT vaciado_id, relleno_id, ruta_camion_id, hora
	FROM registro_vaciado
	WHERE relleno_id = $1
...
// ================== GET BY RUTA CAMION ==================
//
func (pg *PostgresRegistroVaciado) GetByRutaCamionID(rutaCamionID int32) ([]entities.RegistroVaciado, error) {
	sql := `
	SELECT vaciado_id, relleno_id, ruta_camion_id, hora
	FROM registro_vaciado
...
// ================== EXISTS ==================
//
func (pg *PostgresRegistroVaciado) ExistsByID(id int32) (bool, error) {
...
// ================== HELPERS ==================
//
func (pg *PostgresRegistroVaciado) fetchOne(sql string, param any) (*entities.RegistroVaciado, error) {
	var r entities.RegistroVaciado
...
func (pg *PostgresRegistroVaciado) fetchMany(sql string, param any) ([]entities.RegistroVaciado, error) {
